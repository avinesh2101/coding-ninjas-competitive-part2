...
int main()
{
    int n, m;
    cin >> n >> m;
    int *first_row = new int[m];//replaces our input 2d array
    int *second_row = new int[m];

    int *first_dp = new int[m];//replaces our dp 2d array
    int *second_dp = new int[m];

    int *minimum_row_entry = new int[n]; //int this we store our min of each rows col which determine our ans
